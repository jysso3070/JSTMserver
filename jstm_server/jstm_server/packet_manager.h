...
public:
	...
	void send_trap_info_packet(int client_id, SOCKET client_socket, short trap_id, DirectX::XMFLOAT3 trap_pos, char trap_type);
	...
	void send_remove_room(int client_id, SOCKET client_socket, short room_number);
